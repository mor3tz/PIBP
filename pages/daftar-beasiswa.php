    ...
    <section id="beasiswa">
        <div class="container-beasiswa font-semibold">
            ...
            <div class="container-card-beasiswa">
                <!-- ==================== Filter =================== -->
                <div class="filter">
                    <button type="button" id="toggleFilter" class="text-black mt-5 bg-white hover:bg-white focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2   "> <i class="fa-solid fa-filter"></i>Filter</button>
                </div>
                <!-- ==================== Modal Filter =================== -->
