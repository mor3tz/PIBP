...
<body>
  ...
  <nav class="navbar border-gray-200 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <div class="flex md:order-2 mr-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div class="flex md:order-2 mr-2 space-x-3 md:space-x-3 rtl:space-x-reverse">
          <!-- Tombol Login -->
          <button type="button"
  ...
  <!-- ========================= HERO SECTION ===================== -->
  <section id="beranda">
    <div class="beranda relative px-6 pt-60 py-32 mt-10 lg:px-8">
      <!-- Beasiswa -->
      <div id="beasiswa" class="text-center">
        <h1
          class="text-5xl font-semibold tracking-tight text-balance text-gray-900">
          INFORMASI BEASISWA
        </h1>
        <p
          class="mt-5 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
          Selamat datang di situs Informasi Beasiswa. Kami menyediakan
          informasi beasiswa terupdate dari berbagai sumber dalam negeri.
        </p>
        <div class="mt-10 mb-10 flex items-center justify-center gap-x-6">

          <a href="#beasiswa" class="scroll-smooth text-sm/6 font-semibold text-gray-900">Jelajahi <span aria-hidden="true">→</span></a>
        </div>
      </div>
    </div>
  </section>
  <!-- ========================== OVERVIEW ======================= -->
  <section class="pt-20 pb-10 row-container" id="count-stats">
    <div class="bg-gradient-to-b from-white to-gray-800 py-12">
      <div class="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div>
          <h2 class="text-4xl font-bold text-gray-900">300+</h2>
          <h3 class="text-lg font-semibold text-gray-800 mt-2">Coded Elements</h3>
          <p class="text-row text-sm text-gray-600 mt-1">From buttons, to inputs, navbars, alerts or cards, you are covered</p>
        </div>
        <div>
          <h2 class="text-4xl font-bold text-gray-900">100+</h2>
          <h3 class="text-lg font-semibold text-gray-800 mt-2">Design Blocks</h3>
          <p class="text-row text-sm text-gray-600 mt-1">Mix the sections, change the colors and unleash your creativity</p>
        </div>

        <div>
          <h2 class="text-4xl font-bold text-gray-900">41</h2>
          <h3 class="text-lg font-semibold text-gray-800 mt-2">Pages</h3>
          <p class="text-row text-sm text-gray-600 mt-1">Save 3–4 weeks of work when you use <br> our pre-made pages for your website</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- =========================== MAIN CONTENT ==================== -->
  <section id="beasiswa">
    <div class="main-content font-semibold">
      <h1 class="text-4xl">DAFTAR BEASISWA</h1>
      <p>Beasiswa Tersedia Saat ini, yang pastinya up-to-date🎉</p>
      <!-- ==================== Container Card =================== -->
      <div class="container-card">
        <!-- ==================== Filter =================== -->
        <div class="filter">
          <button type="button" id="toggleFilter" class="text-white bg-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> <i class="fa-solid fa-filter"></i>Filter</button>
        </div>
        <!-- ==================== Modal Filter =================== -->
        <div class="modal-filter" id="modalFilter" style="display: none;">

          <div class="filter-form" id="liveFilterForm">
            <!-- Input Teks -->
            <div class="filter-group">
              <label for="search">Cari Beasiswa</label>
              <input type="text" id="search" name="search" placeholder="Ketik nama beasiswa..." autocomplete="off">
            </div>
            ...
            <!-- Dropdown label-->
            <div class="filter-group">
              <label for="labelFilter">Popular</label>
        ...
        <div class="content-more">
          ...
          <a href="./pages/daftar-beasiswa.php" class="more-link" target="_blank">
  ...
  <!-- ============================ FOOTER ========================= -->
  <footer class="footer">
    <div class="mx-auto max-w-screen-xl pt-10 space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
  ...
  <!-- ============================= Flowbite ====================== -->
  <script src="https://cdn.jsdelivr.net/npm/flowbite@3.1.2/dist/flowbite.js"></script>
</body>
